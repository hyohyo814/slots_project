default:
	...
	avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega2560 -c -o millis.o millis.c
	avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega2560 -c -o main.o main.c
	avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega2560 main.o steppers.o segments.o millis.o
